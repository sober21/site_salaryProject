...
from main.my_database import execute_read_query, connection, get_salary_data_month
...
if __name__ == '__main__':
    ...
    # c_date = current_date
    # print(get_salary_data_month(email='max@mail.ru', cur_data=c_date)('+'))
    # print(get_salary_data_month(email='max@mail.ru', cur_data=c_date)('+'))
    # print(get_salary_data_month(email='max@mail.ru', cur_data=c_date)('+'))
    # print(get_salary_data_month(email='max@mail.ru', cur_data=c_date)('+'))
    if 's'.isalpha():
        print('a')
    action = '+' if '1'.isdigit() else '-'
    if 'a'.isdigit():
        print('digit')
    print(action)